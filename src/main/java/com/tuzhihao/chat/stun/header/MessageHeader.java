...
package com.tuzhihao.chat.stun.header;

import com.tuzhihao.chat.stun.attribute.MessageAttribute;
import com.tuzhihao.chat.stun.attribute.MessageAttributeParsingException;
import com.tuzhihao.chat.stun.util.Utility;
...
public class MessageHeader implements MessageHeaderInterface {
    ...
    TreeMap<MessageAttribute.MessageAttributeType, MessageAttribute> ma = new TreeMap<>();
    ...
    public boolean equalTransactionID(MessageHeader header) {
        ...
        if ((idHeader[0] == id[0]) && (idHeader[1] == id[1]) && (idHeader[2] == id[2]) && (idHeader[3] == id[3]) &&
                ...
                &&
                (idHeader[12] == id[12]) && (idHeader[13] == id[13]) && (idHeader[14] == id[14]) && (idHeader[15]
                == id[15])) {
            return true;
        } else {
            return false;
